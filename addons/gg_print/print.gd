...
## Prints text in the editor's output panel with a clickable link back to the source script.
##
...
## If [param stack_depth] is provided, it'll link back to the respective source
## (see [method @GDScript.get_stack]).
